...
def pause():
    ...
    '''
    message_to_screen("Paused", BLACK, -80, size="large")
...
def game_intro():
    ...
    while intro:
        ...
        message_to_screen("The objective of the game is to eat the food!", BLACK, -50)
        message_to_screen("The more food you eat, the longer you get.", BLACK, -10)
        message_to_screen("If you run into yourself or the edges, you lose.", BLACK, 30)
        message_to_screen("Press C to play, P to pause, and Q to quit", BLACK, 170)
...
def game_loop():
    ...
    while not game_exit:
        ...
        if game_over:
            ...
            message_to_screen("Press C to play again or Q to quit", BLACK, y_displace = 30, size = "medium")
            pygame.display.update()
